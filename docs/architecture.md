...
│   │     └── <Routes>  16 rotas → 1 componente-ferramenta   │ │
...
- 16 rotas mapeando 1:1 para um componente-ferramenta (ver `docs/api.md` e `docs/modules.md`).
...
└── app/                        # a aplicação de fato
    ...
    └── src/
        ...
        └── components/
            ...
            ├── CommandPalette.tsx
            ├── ErrorBoundary.tsx
            ├── ToolLayout.tsx   # shell `.main-content` + `.tool-header`, usado pelas 16 tools
            ├── ToolPanel.tsx    # painel glass-panel com label + ações, usado onde há par input/output
            └── *Tool.tsx        # 16 componentes-ferramenta
```
